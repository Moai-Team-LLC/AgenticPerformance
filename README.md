...
- ✅ **GitHub issues** — https://github.com/AlexDuchDev/apl, 37 issues; #1–23 помечены статусом.
- ⏳ Далее: **Phase 4** (#24–28) — L1→L2 цикл улучшения + content-safety на майненых артефактах + diff-allowlist границы автономии + improvement-ledger. Инфра-хвосты: #9 (OTLP-ресивер+writer), #16 judge-runner, #11 бенч, #20 LLM-таксономия.
