...
- ✅ **GitHub issues** — https://github.com/AlexDuchDev/apl, 37 issues; #1–28 помечены статусом.
- ⏳ Далее: **Phase 5** (#29–32) — L3 eligibility (code-enforced) + независимый gating-судья (sealed held-out) + durable resumable improvement state-machine + canary/A-B. Инфра-хвосты: #9, #11, #16, #20, #25.
