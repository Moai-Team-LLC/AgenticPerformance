...
- ✅ **GitHub issues** — https://github.com/AlexDuchDev/apl, 37 issues; #1–10 помечены статусом.
- ⏳ Далее: замкнуть #9 (OTLP-ресивер+writer, нужна БД) → **Phase 2** (#12–16: golden-set БД, baseline-сьют, версионный CI-гейт).
