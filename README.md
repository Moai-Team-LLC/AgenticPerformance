...
- ✅ **GitHub issues** — https://github.com/AlexDuchDev/apl, 37 issues; #1–16 помечены статусом.
- ⏳ Далее: **Phase 3** (#17–23) — judge-таблица + стратиф. калибровка (Wilson) + failure/clustering (стабильность) + significance-тренды + headless scorecard. Инфра-хвосты: #9 (OTLP-ресивер+writer, нужна БД), #16, #11.
