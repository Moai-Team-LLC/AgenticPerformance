...
- ⏳ **GitHub issues из бэклога** — нужен целевой репозиторий (не выбираю за владельца: публичный AgenticMind не годится для внутреннего трекинга).
- ⏳ Далее по плану: Phase-0 нормализация-контракт + fixture-продукты (APL-0.2/0.5); затем Phase 1 (SDK + OTLP-ресивер + Timescale-стор).
